...
<!-- Mirrored from eres.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Nov 2021 03:44:26 GMT -->
<head>
    <meta charset="utf-8">
   ...
   <!-- Favicon icon -->
	...
	<link href="<?= base_url() ?>cdn.lineicons.com/2.0/LineIcons.css" rel="stylesheet">
	<!-- Form step -->
...
<body>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<div class="plus-box">
						<p class="fs-16 font-w500 mb-1">WELCOM TO E-DOKAR</p>
					</div>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="<?= base_url('data_pns') ?>">PNS</a></li>
							<li><a href="<?= base_url('data_p3k') ?>">P3K</a></li>
							<li><a href="<?= base_url('data_thl') ?>">THL</a></li>
							<li><a href="<?= base_url('data_kontrak') ?>">Kontrak</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?= base_url('master_user') ?>">Pengguna</a></li>
    ...
    ***********************************-->
	...
	<script src="vendor/owl-ca/rousel/owl.carousel.js"></script>
