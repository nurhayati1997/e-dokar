									...
									<div class="col-xl-4">
										...
										<div class="card card-custom bg-gray-100 gutter-b card-stretch">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title font-weight-bolder text-white">Data Berdasarkan Status</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
													...
													<div class="row m-0">
														<div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
																...
																<a href="#" class="text-warning font-weight-bold font-size-h6">PNS : <?php echo $total_pns; ?></a>
															
															<div class="card-toolbar">
																<div class="dropdown dropdown-inline">
																	<?php if ($this->session->userdata("rule") == 1) { ?>	
																		<a href="#" class="btn btn-white btn-sm font-weight-bolder px-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Export</a>
																	<?php } ?>
																</div>
															</div>
														</div>
