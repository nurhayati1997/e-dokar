...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:32:21 GMT -->
<!-- Added by HTTrack -->
...
<!-- /Added by HTTrack -->
	<head>
		...
		<link href="assets/plugins/custom/fullcalendar/fullcalendar.bundle5883.css?v=7.2.9" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							...
							<div class="topbar">
								...
								<div class="d-flex align-items-center">
									<!--begin::Button-->
									<a href="<?= base_url("login/logout") ?>" class="btn btn-transparent-white font-weight-bold py-3 px-6 mr-2">Log Out</a>
									<!--end::Button-->
								</div>
								<!--end::Toolbar-->
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">E-dokar RSUD SYAMRABU</h2>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
		...
		<script src="assets/plugins/custom/fullcalendar/fullcalendar.bundle5883.js?v=7.2.9"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="assets/js/pages/widgets5883.js?v=7.2.9"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:34:29 GMT -->
</html>