...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/custom/apps/education/student/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:39:51 GMT -->
...
<head>
		...
		<meta charset="utf-8" />
		<title>E-Dokar SYAMRABU| Keenthemes</title>
		<meta name="description" content="Profile example" />
	...
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
																...
																<ul class="menu-subnav">
																	<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																		...
																		<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																			<ul class="menu-subnav">
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../school/dashboard.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																						<span class="menu-text">Dashboard</span>
																				...
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../school/statistics.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																				...
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../school/calendar.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																						<span class="menu-text">Calendar</span>
																				...
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../school/library.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																				...
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../school/teachers.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																				...
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../school/students.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																	...
																	<li class="menu-item menu-item-open menu-item-here menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																		...
																		<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																			<ul class="menu-subnav">
																				...
																				<li class="menu-item" aria-haspopup="true">
																					<a href="classmates.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																	...
																	<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																		...
																		<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																			<ul class="menu-subnav">
																				<li class="menu-item" aria-haspopup="true">
																					<a href="../class/dashboard.html" class="menu-link">
																						<i class="menu-bullet menu-bullet-line">
																							<span></span>
																						</i>
																						<span class="menu-text">Dashboard</span>
														...
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="../../ecommerce/my-orders.html" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
											<!--begin::Header-->
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(../../../../../theme/html/demo2/dist/assets/media/misc/bg-1.jpg)">
												<!--begin::Title-->
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<!--begin:Header-->
										<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(../../../../../theme/html/demo2/dist/assets/media/misc/bg-1.jpg)">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
										<form>
											<!--begin::Header-->
											<div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(../../../../../theme/html/demo2/dist/assets/media/misc/bg-1.jpg)">
											...
											<div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="../../../../../theme/html/demo2/dist/assets/media/stock-600x400/img-1.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
												<!--begin::Separator-->
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="../../../../../theme/html/demo2/dist/assets/media/stock-600x400/img-2.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
												<!--begin::Separator-->
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="../../../../../theme/html/demo2/dist/assets/media/stock-600x400/img-3.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
												<!--begin::Separator-->
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="../../../../../theme/html/demo2/dist/assets/media/stock-600x400/img-4.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
											</div>
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
											<img class="h-20px w-20px rounded-sm" src="https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/svg/flags/226-united-states.svg" alt="" />
										</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
										...
										<ul class="navi navi-hover py-4">
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/svg/flags/226-united-states.svg" alt="" />
													</span>
											...
											<li class="navi-item active">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/svg/flags/128-spain.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/svg/flags/162-germany.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/svg/flags/063-japan.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="https://preview.keenthemes.com/metronic/theme/html/demo2/dist/assets/media/svg/flags/195-france.svg" alt="" />
													</span>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Education</a>
											<!--end::Item-->
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Student</a>
											<!--end::Item-->
											<!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
											<a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Profile</a>
											<!--end::Item-->
										</div>
										<!--end::Breadcrumb-->
									</div>
												...
												<div>
													...
													<div class="d-flex align-items-center mb-8">
														...
														<div class="symbol mr-5 pt-1">
															<div class="symbol-label min-w-65px min-h-100px" style="background-image: url('../../../../../theme/html/demo2/dist/assets/media/books/4.png')"></div>
														</div>
														<!--end::Symbol-->
														<!--begin::Info-->
														<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-8">
														<!--begin::Symbol-->
														<div class="symbol mr-5 pt-1">
															<div class="symbol-label min-w-65px min-h-100px" style="background-image: url('../../../../../theme/html/demo2/dist/assets/media/books/12.png')"></div>
														</div>
														<!--end::Symbol-->
														<!--begin::Info-->
														<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center">
														<!--begin::Symbol-->
														<div class="symbol mr-5 pt-1">
															<div class="symbol-label min-w-65px min-h-100px" style="background-image: url('../../../../../theme/html/demo2/dist/assets/media/books/13.png')"></div>
														</div>
														<!--end::Symbol-->
														<!--begin::Info-->
														<div class="d-flex flex-column">
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo1/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo1/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						...
						<div class="overlay-layer">
							<a href="profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="../../../../rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo3/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo3/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo4/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo4/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo5/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo5/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo6/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo6/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo7/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo7/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo8/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo8/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo9/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo9/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo10/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo10/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo11/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo11/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo12/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo12/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						...
						<div class="overlay-layer">
							<a href="https://preview.keenthemes.com/metronic/demo13/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
							<a href="https://preview.keenthemes.com/metronic/demo13/rtl/custom/apps/education/student/profile.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
						</div>
					</div>
		...
		<script src="assets/js/pages/custom/education/student/profile5883.js?v=7.2.9"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->

<!-- Mirrored from preview.keenthemes.com/metronic/demo2/custom/apps/education/student/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:39:52 GMT -->
</html>