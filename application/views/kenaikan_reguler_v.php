                      ...
                      <?php } ?>
							...
							<!-- Tambah -->
                              ...
                              <div class="form-group mb-3">
															...
															<div class="form-group mb-3">
																<span class="form-text text-muted">Upload Fotocopy STLUD Bagi yang Pindah Golongan</span>
																<div class="custom-file">
																	<input type="file" class="custom-file-input" id="file_fc_stlud" />
																	<label class="custom-file-label" for="customFile">File FC STLUD format pdf</label>
																</div>
															</div>
															<div class="form-group mb-3">
															...
															<div class="form-group mb-3">
																<span class="form-text text-muted">Upload Fotocopy SK CPNS dan PNS <br>(Bagi PNS yang Baru yang baru pertama kali naik pangkat)</span>
																<div class="custom-file">
																	<input type="file" class="custom-file-input" id="file_fc_cpns_pns" />
  ...
  function tambah_baru() {
      if (document.getElementById('tgl_kenaikan').value == "") {
          ...
          $.ajax({
              ...
              + '&file_fc_stlud=' +  document.getElementById('file_fc_stlud').value + '&file_fc_ijazah_terakhir=' +  document.getElementById('file_fc_ijazah_terakhir').value
              + '&file_fc_skp_2_tahun=' +  document.getElementById('file_fc_skp_2_tahun').value + '&file_fc_cpns_pns=' +  document.getElementById('file_fc_cpns_pns').value
              ...
              + '&file_asli_transkip=' +  document.getElementById('file_asli_transkip').value+ '&jenis_kenaikan_reguler=' +  document.getElementById('jenis_kenaikan_reguler').value,
