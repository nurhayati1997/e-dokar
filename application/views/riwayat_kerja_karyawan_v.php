...
<script>
  ...
  function tampilkan(){
    ...
    var baris = '<table class="table table-separate table-head-custom table-checkable" id="tabelUser"><thead class="thead-light"><tr><th>Action</th><th>NO</th><th>Nama</th><th>Ruangan</th><th>No SK</th><th>Tgl SK</th><th>Nama Pimpinan</th><th>Tahun</th></tr></thead>'
      $.ajax({
        type:'POST',
